...
RUN R -e "install.packages(c('thematic', 'bsicons', 'bslib', 'bs4Dash', 'fresh', 'shinycssloaders', 'plotly', 'remotes', 'pkgload', 'googleAuthR', 'glue', 'gtrendsR'), repos='http://cran.rstudio.com/')"
